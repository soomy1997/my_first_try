...
import 'package:myfirsttry/pages/ForgetPass.dart';
...
class _LoginSignupPageState extends State<LoginSignupPage> {
  ...
  bool validateAndSave() {
    reload();
      ...
      void GoToForgetPass(){
        Navigator.push(context, new MaterialPageRoute(builder: (ctxt) => new ForgetPass()));
      }
      ...
      void getAccess(){Navigator.push(context, new MaterialPageRoute(builder: (ctxt) => new SignupPage(
        auth: widget.auth,
